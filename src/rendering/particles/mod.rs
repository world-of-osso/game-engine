...
// Raw M2 file flags, not CParticleEmitter's translated runtime PROP_* bits.
pub(super) const PARTICLE_FLAG_TAIL_PARTICLES: u32 = 0x0004_0000;
pub(super) const PARTICLE_FLAG_WORLD_SPACE: u32 = 0x0000_0010;
pub(super) const PARTICLE_FLAG_BONE_SCALE: u32 = 0x0000_0020;
pub(super) const PARTICLE_FLAG_INHERIT_VELOCITY: u32 = 0x0000_0040;
pub(super) const PARTICLE_FLAG_INHERIT_POSITION: u32 = 0x0000_0800;
pub(super) const PARTICLE_FLAG_XY_QUAD: u32 = 0x0000_1000;
pub(super) const PARTICLE_FLAG_NEGATE_SPIN: u32 = 0x0000_0200;
pub(super) const PARTICLE_FLAG_CLAMP_TAIL_TO_AGE: u32 = 0x0000_0400;
pub(super) const PARTICLE_FLAG_PROJECT_PARTICLE: u32 = 0x0000_2000;
pub(super) const PARTICLE_FLAG_FOLLOW_POSITION: u32 = 0x0000_4000;
pub(super) const PARTICLE_FLAG_RANDOM_TEXTURE: u32 = 0x0001_0000;
pub(super) const PARTICLE_FLAG_VELOCITY_ORIENT: u32 = 0x0000_0004;
pub(super) const PARTICLE_FLAG_SIZE_VARIATION_2D: u32 = 0x0008_0000;
pub(super) const PARTICLE_FLAG_NO_GLOBAL_SCALE: u32 = 0x0200_0000;
pub(super) const PARTICLE_FLAG_OFFSET_BY_SPIN: u32 = 0x0800_0000;
pub(super) const PARTICLE_FLAG_WIND_DYNAMIC: u32 = 0x8000_0000;
