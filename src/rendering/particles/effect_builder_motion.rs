...
pub(crate) fn build_twinkle_modifier(
    em: &M2ParticleEmitter,
) -> Option<super::visuals::TwinkleSizeModifier> {
    has_authored_twinkle(em).then(|| super::visuals::TwinkleSizeModifier {
...
pub(crate) fn build_size_variation_modifier(
    em: &M2ParticleEmitter,
) -> Option<super::visuals::SizeVariationModifier> {
    has_authored_size_variation(em).then_some(super::visuals::SizeVariationModifier)
}
