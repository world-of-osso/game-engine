...
// Raw M2 file flags; shared modifiers consume M2ParticleEmitter.flags directly.
const PARTICLE_FLAG_TAIL_PARTICLES: u32 = 0x0004_0000;
const PARTICLE_FLAG_INHERIT_POSITION: u32 = 0x0000_0800;
const PARTICLE_FLAG_FOLLOW_POSITION: u32 = 0x0000_4000;
const PARTICLE_FLAG_XY_QUAD: u32 = 0x0000_1000;
const PARTICLE_FLAG_NEGATE_SPIN: u32 = 0x0000_0200;
const PARTICLE_FLAG_CLAMP_TAIL_TO_AGE: u32 = 0x0000_0400;
const PARTICLE_FLAG_RANDOM_TEXTURE: u32 = 0x0001_0000;
const PARTICLE_FLAG_VELOCITY_ORIENT: u32 = 0x0000_0004;
const PARTICLE_FLAG_SIZE_VARIATION_2D: u32 = 0x0008_0000;
const PARTICLE_FLAG_NO_GLOBAL_SCALE: u32 = 0x0200_0000;
const PARTICLE_FLAG_OFFSET_BY_SPIN: u32 = 0x0800_0000;
const PARTICLE_FLAG_WIND_DYNAMIC: u32 = 0x8000_0000;
