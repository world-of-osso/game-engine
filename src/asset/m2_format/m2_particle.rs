...
const EMITTER_TAIL_LENGTH_OFFSET: usize = 0x15C;
...
const EMITTER_TWINKLE_SPEED_OFFSET: usize = 0x160;
const EMITTER_TWINKLE_PERCENT_OFFSET: usize = 0x164;
const EMITTER_TWINKLE_SCALE_MIN_OFFSET: usize = 0x168;
const EMITTER_TWINKLE_SCALE_MAX_OFFSET: usize = 0x16C;
const EMITTER_HEAD_CELL_TRACK_OFFSET: usize = 0x13C;
const EMITTER_TAIL_CELL_TRACK_OFFSET: usize = 0x14C;
const EMITTER_BURST_MULTIPLIER_OFFSET: usize = 0x170;
