...
fn zeroed_emitter_state() -> M2ParticleEmitter {
    let mut emitter = base_zeroed_emitter();
...
fn base_zeroed_emitter() -> M2ParticleEmitter {
    M2ParticleEmitter {
        flags: 0,
        position: [0.0; 3],
        texture_fdid: None,
        ..base_zeroed_emitter_tail()
    }
}

fn base_zeroed_emitter_tail() -> M2ParticleEmitter {
    M2ParticleEmitter {
        bone_index: 0,
        texture_index: 0,
        blend_type: 0,
...
fn base_zeroed_emitter_visuals() -> M2ParticleEmitter {
    M2ParticleEmitter {
        ...
        wind_vector: [0.0; 3],
        wind_time: 0.0,
        ..base_zeroed_emitter_visual_payload()
    }
}

fn base_zeroed_emitter_visual_payload() -> M2ParticleEmitter {
    M2ParticleEmitter {
        colors: [[0.0; 3]; 3],
        color_keys: Vec::new(),
        opacity: [0.0; 3],
        ...
        mid_point: 0.0,
        ..base_zeroed_emitter_seed()
    }
}

fn base_zeroed_emitter_seed() -> M2ParticleEmitter {
    M2ParticleEmitter {
        flags: 0,
        position: [0.0; 3],
        texture_fdid: None,
...
fn base_zeroed_emitter_seed_tail() -> M2ParticleEmitter {
    M2ParticleEmitter {
        ...
        area_width: 0.0,
        drag: 0.0,
        ..base_zeroed_emitter_seed_visuals()
    }
}

fn base_zeroed_emitter_seed_visuals() -> M2ParticleEmitter {
    M2ParticleEmitter {
        base_spin: 0.0,
        base_spin_variation: 0.0,
        spin: 0.0,
        ...
        burst_multiplier: 0.0,
        mid_point: 0.0,
        ..base_zeroed_emitter_seed_core()
    }
}

fn base_zeroed_emitter_seed_core() -> M2ParticleEmitter {
    M2ParticleEmitter {
        flags: 0,
        position: [0.0; 3],
        texture_fdid: None,
        ..base_zeroed_emitter_seed_core_tail()
    }
}

fn base_zeroed_emitter_seed_core_tail() -> M2ParticleEmitter {
    M2ParticleEmitter {
        bone_index: 0,
        texture_index: 0,
        blend_type: 0,
        ...
        area_width: 0.0,
        drag: 0.0,
        ..base_zeroed_emitter_seed_core_visuals()
    }
}

fn base_zeroed_emitter_seed_core_visuals() -> M2ParticleEmitter {
    M2ParticleEmitter {
        base_spin: 0.0,
        base_spin_variation: 0.0,
        spin: 0.0,
        ...
        burst_multiplier: 0.0,
        mid_point: 0.0,
        ..base_zeroed_emitter_seed_core_seed()
    }
}

fn base_zeroed_emitter_seed_core_seed() -> M2ParticleEmitter {
    M2ParticleEmitter {
        flags: 0,
        position: [0.0; 3],
        texture_fdid: None,
        ..base_zeroed_emitter_seed_core_seed_tail()
    }
}

fn base_zeroed_emitter_seed_core_seed_tail() -> M2ParticleEmitter {
    M2ParticleEmitter {
        bone_index: 0,
        texture_index: 0,
        blend_type: 0,
