...
fn zeroed_emitter_seed() -> M2ParticleEmitter {
    M2ParticleEmitter {
        ...
        area_width: 0.0,
        drag: 0.0,
        ..zeroed_emitter_seed_tail()
    }
}

fn zeroed_emitter_seed_tail() -> M2ParticleEmitter {
    M2ParticleEmitter {
        base_spin: 0.0,
        base_spin_variation: 0.0,
        spin: 0.0,
        ...
        burst_multiplier: 0.0,
        mid_point: 0.0,
        ..zeroed_emitter_seed_base()
    }
}

fn zeroed_emitter_seed_base() -> M2ParticleEmitter {
    M2ParticleEmitter {
        flags: 0,
        position: [0.0; 3],
        bone_index: 0,
        ...
        area_width: 0.0,
        drag: 0.0,
        ..zeroed_emitter_seed_rest()
    }
}

fn zeroed_emitter_seed_rest() -> M2ParticleEmitter {
    M2ParticleEmitter {
        base_spin: 0.0,
        base_spin_variation: 0.0,
        spin: 0.0,
