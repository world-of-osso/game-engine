...
Borrowing follow-ups `6802940` and `66e6d35` remove eager source-text copies without caches; see the [UI record](../systems/ui-system.md). Existing shadow cases and five main-text cases pass before/after, including two new Unicode/password cases. This adds two distinct tests to the batch above, not another eight. [Shadow build integration](../../../data/diagnostics/unchanged-writes-20260909/shadow-borrow/verification/final-integration-report.md) and [main-text compilation integration](../../../data/diagnostics/unchanged-writes-20260909/text-borrow/verification/final-integration-report.md) pass with recorded provenance limits. Password-mask generation still allocates; no allocation-count or CPU measurement was performed.
