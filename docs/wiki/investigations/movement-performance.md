...
Toolkit commits `c8fa209`/`c3a518a`, `3e6951d`, `eebcf28`, `67413da`, `2b3c1f3`, and `f041c0e` remove unchanged renderer-owned component writes, settled button nine-slice invalidation, and clean render-dirty resource mutation. Exact behavior and retained reconciliation boundaries are the [UI system record](../systems/ui-system.md). Separate focused suites establish 21 distinct new behavioral tests: text 3, shadow 3, button 3, nine-slice 4, tiled 4, and render-dirty clearing 4; this is not one combined suite. Proof: [text](../../../data/diagnostics/unchanged-writes-20260909/text-components/verification/final-report.md), [shadow](../../../data/diagnostics/unchanged-writes-20260909/shadow-components/verification/final-report.md), [button](../../../data/diagnostics/unchanged-writes-20260909/button-nine-slice/verification/final-report.md), [nine-slice](../../../data/diagnostics/unchanged-writes-20260909/nine-slice-components/verification/report.md), [tiled](../../../data/diagnostics/unchanged-writes-20260909/tiled-components/verification/report.md), and [render-dirty clearing](../../../data/diagnostics/unchanged-writes-20260909/render-dirty-clear/verification/report.md). No native or CPU-savings claim.
