...
- Density GPU RED showed the loaded mid-density case had no bright cloud pixels (maximum 64). At `a55e0f5b`, the generated-texture fixture reports 22.12% bright pixels and 60.16% dark pixels at mid density; full density is 100% bright and clear density 100% dark. Native capture remains pending.
