...
- [procedural-cloud-regeneration](investigations/procedural-cloud-regeneration.md) — Procedural cloud hotspot, corrected performance evidence, presentation/SSAO fixes, empty-stage UI flood root cause, and machine-side relaunch proof; human visual gate pending
