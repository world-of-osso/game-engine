...
- [ui-system](systems/ui-system.md) — toolkit rsx!/Screen/SharedContext screens plus native Bevy login and loading entities authored through direct native RSX, semantic automation/dumps, anchor layout, conditional visibility/alpha and quad invalidation, nameplates, in-world stage gates, unit frames, keybindings, World Builder sidebar; loading readiness/layout/render proof passes within stated limits
